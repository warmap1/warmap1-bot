...
def start(m):
    bot.send_message(m.chat.id, 'Hi! Here you can learn more about me, get in touch, find useful links, and stay updated with the latest news. Choose an option below!', reply_markup=kb.menu)
